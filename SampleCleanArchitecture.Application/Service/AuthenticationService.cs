...
namespace SampleCleanArchitecture.Application.Service
{
    internal sealed class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<bool> ValidateUser(UserForAuthenticationDto userForAuth)
        {
            ...
            //if (_user?.Id != null) LoggedInUserInfo.UserId = _user?.Id;
            return result;
        }
        ...
        public async Task<TokenDto> CreateToken(bool populateExp)
        {
            ...
            return new TokenDto()
            {
                RefCompanyId = _user.RefCompanyId,
                Email = _user.Email,
        ...
        private async Task<List<Claim>> GetClaims()
        {
            var claims = new List<Claim>
            {
                ...
                new Claim(CustomClaimTypes.RefCompanyId, _user.RefCompanyId.ToString())
            };
        ...
        private JwtSecurityToken GenerateTokenOptions(SigningCredentials signingCredentials, List<Claim> claims)
        {
            ...
            (
                ...
                claims: claims,
                expires: DateTime.Now.AddMinutes(Convert.ToDouble(_jwtConfiguration.Expires)), //jwtSettings["expires"]
    ...
    {
        public const string RefCompanyId = "refCompanyId";
    }
